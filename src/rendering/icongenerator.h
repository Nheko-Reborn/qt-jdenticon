...
protected:
    ...
    virtual void RenderBackground(Renderer &renderer, Rectangle rect, IdenticonStyle &style, ColorTheme &colorTheme, QByteArray &hash)
    {
        Q_UNUSED(rect);
        Q_UNUSED(style);
        Q_UNUSED(colorTheme);
    ...
    virtual void RenderForeground(Renderer &renderer, Rectangle &rect, IdenticonStyle &style, ColorTheme &colorTheme, QByteArray &hash)
    {
        Q_UNUSED(style);
